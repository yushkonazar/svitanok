...
const EXPECTED_COLUMNS: Record<string, string[]> = {
  ...
  reminders: [
    ...
    'chat_id',
    'thread_id',
    // Повтор (0012, реліз 08.09): NULL = одноразове. Колонка приїхала ОКРЕМО
    // від коду - див. шапку міграції: Workers Builds деплоїть кожен push, а
    // migrate.yml працює лише на мержі в main.
    'rrule',
    'recur_count',
  ],
  proposals: [
