...
// лише чисті функції: валідація, мердж, тихі години.
//
...
// Mini App, Telegram-пропозиція та policy інструменти можуть писати паралельно,
// тож їх серіалізує StateStoreDO; окремий slot не змішує settings із `state`.
//
// Форма:
