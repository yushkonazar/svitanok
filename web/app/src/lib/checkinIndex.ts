...
export const FIELD_LABEL: Record<string, string> = {
  // ⚠️ Шість полів реєстру доти взагалі не мали тут підпису — і драйвер по них
  // виводився сирим ключем моделі ('mainProgress'), бо fieldLabel навмисно
  // падає назад на ключ, а не ховає рядок. Дешевий недогляд із дорогим
  // наслідком: рядок, який неможливо прочитати, читається як збій.
  sleepKind: 'Режим ночі',
  sleepH: 'Сон (год)',
  sleepQ: 'Якість сну',
  sleepLatency: 'Час засинання',
  awakenings: 'Нічні пробудження',
  bedtime: 'Час відбою',
  bodyFeel: 'Тіло зранку',
  dayLoad: 'Завантаженість дня',
  interrupted: 'Збивали ззовні',
  mainProgress: 'Прогрес до обіду',
  movePlan: 'Намір руху',
  outdoorNow: 'Надворі до обіду',
  dayControl: 'Очікуваний контроль',
