...
const num = z.number();
// ⚠️ .int() КЛИЧЕТЬСЯ. Доти константа звалась `int`, а перевірки цілості не
// робила ЖОДНОЇ: сервер міг віддати 3.7 там, де контракт обіцяє лічильник, і
// safeParse це пропускав. «Документація іменем» без підкріплення в коді — той
// самий клас, що «впевнене число без підстав» із ревізії статистики.
