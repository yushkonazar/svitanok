...
export function QuoteBlock({ d }: { d: StoicData }) {
  ...
  return (
    <div className="relative pl-11 pt-2.5">
      <div
        className="absolute left-0 top-[-6px] text-[58px] font-extrabold leading-none"
        style={{
          background: 'var(--grad)',
      ...
      <div className="mt-2 flex items-center gap-2">
        ...
        <span className="font-mono text-[10.5px] font-medium text-tx3">{d.author.toUpperCase()}</span>
        <div className="ml-auto">
