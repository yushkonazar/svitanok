...
export const BLOCKS: Block[] = [
  {
    ...
    qs: [
      ...
      { ...DAY_AHEAD },
      {
        ...
        //
        // Рівні дзеркалять вечірній `moved` (окрім 'active', якого в намірі не
        // буває): інакше пара «намір проти факту» порівнювала б різні шкали.
        id: 'movePlan',
        t: 'Рух заплановано?',
        soft: true,
        o: [
  ...
  },
  {
    ...
    qs: [
      ...
      },
      {
        ...
        //
        // Формулювання «які вже горять» теж навмисне: невідмічені варіанти
        // читаються як список справ на найближчу годину, а не як докір.
        //
        ...
        id: 'flames',
        t: 'Вогники — які вже горять сьогодні?',
        kind: 'multi',
        max: 5,
        soft: true,
        o: [
