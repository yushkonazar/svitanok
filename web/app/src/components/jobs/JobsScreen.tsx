...
//
// ВІДОМИЙ ПРОБІЛ (закриє канбан, наступний крок): у списку видно лише вакансії
// з СЬОГОДНІШНЬОГО брифінгу. Ті, що лежать у stats.funnelList із минулих днів,
// зараз недосяжні — раніше до них вів FunnelDetail (кнопки стадій + видалення),
// але макет замінює його канбаном, де лейни джерелом мають саме funnelList.
// Тож FunnelDetail прибрано, а канбан (4 лейни на наявних стадіях + drag&drop)
// має зʼявитись до релізу, інакше це регрес проти E3.
