        ...
        <div className="flex flex-col gap-3.5">
          {rows.map((r) => (
            <div key={r.key} className="rounded-2xl border border-glassb bg-glass p-3.5">
              ...
              {/* ⚠️ Підписи осі — свої, а не з MiniTrend. Той форматує ISO-дати
                  («10.08»), і на місячному ряді це читалось би як ЧИСЛО, а не
                  як місяць: «01.07» виглядає першим липня, хоч означає весь
                  липень. Порожній `weeks` вимикає його підписи, а перший і
                  останній місяць пишемо самі — 14 підписів у ряд однаково не
                  влізли б на 375px. */}
