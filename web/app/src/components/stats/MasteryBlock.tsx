    ...
    <div className="flex flex-col gap-3.5">
      ...
      {rated.length > 0 && (
        <Card>
          ...
          <Hint>
            Верхня смуга — скільки підпунктів теми ти відмітив пройденими, нижня — скільки питань
            по ній НЕ виявились складними. Теми впорядковані за розривом: угорі ті, де відмічено
      ...
      {unrated.length > 0 && (
        <Card>
          ...
          <Hint>
            ...
            погано»: це різні речі — не даються й не питали. Поки їх не перевірено, про них
            нічого не відомо, скільки б підпунктів не було відмічено.
          </Hint>
        </Card>
      )}
