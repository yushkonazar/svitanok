      ...
      {flames.tops.length > 0 && (
        <Card>
          ...
          {/* ⚠️ ТУТ БУВ підблок «Що частіше пропускаю» — рейтинг застосунків за
              ...
              ⚠️ Тепер прибрано й із СЕРВЕРА (17.08): картки не було вже місяць, а
              лічильник усе одно рахувався на кожному /api/stats і їхав у
              відповіді. Мертвий рахунок у бюджеті 10 мс — не безкоштовний.
              Знадобиться знову — `git show` поверне його за хвилину. */}
        </Card>
      )}
    </div>
  );
