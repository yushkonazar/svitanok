 ...
 * Менше — сторож дублював би роботу alarm'а при звичайному джитері воркерда;
 * більше — задачі стояли б довше, ніж один 5-хвилинний тік крону.
 */
export const WATCHDOG_GRACE_MS = 2 * 60_000;

/** Стеля вибірки джитера: доба 5-хвилинних появ. Старіше витісняється. */
export const JITTER_SAMPLES_CAP = 288;
