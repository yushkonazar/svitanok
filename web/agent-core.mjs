...
export const ASSISTANT_ACTION_SCHEMA = {
  ...
  properties: {
    ...
    // полів — компроміс під удвічі меншу тодішню MAX_SCHEMA_LEN, який не давав
    // скласти в один батч два readMail з різними запитами. Межу відтоді підняли,
    // тож тримати цей компроміс немає причин.
    reads: {
      type: 'array',
      items: {
        type: 'object',
