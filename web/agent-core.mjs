...
/** Раунди вичерпано: агент читав дані, але так і не дійшов до фінальної дії. */
...
/**
 * Бюджет часу вичерпано (див. AGENT_DEADLINE_MS у worker.js). Окремий текст:
 * це не «модель дурна» й не «раунди скінчились» — це ми не встигли.
 */
export const ASSISTANT_TIME_REPLY =
  '⌛ Не встиг усе зробити за один раз. Розбий на кроки — спершу «знайди лист …», потім «заплануй подію …».';
